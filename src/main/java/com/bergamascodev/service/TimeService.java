...
public class TimeService {
    ...
    public TimeDto criar(TimeDto timeDto) {
        ...
        try {
            ...
            throw gerarTimeExcpetion(MensagemErroEnum.FALHA_SALVAR_CATEGORIA);
        }
    }
    ...
    public TimeDto buscarPorId(Long id) {
        ...
        if (timeOptional.isEmpty()){
            throw gerarTimeExcpetion(MensagemErroEnum.TIME_NAO_ENCONTRADO, ResponseEnum.REQUISICAO_INVALIDA);
        }
    ...
    private BergamascoException gerarTimeExcpetion(MensagemErroEnum mensagensErroEnum) {
        return new BergamascoException(mensagensErroEnum.getCodigo(), mensagensErroEnum.getMensagem());
    }

    private BergamascoException gerarTimeExcpetion(MensagemErroEnum mensagensErroEnum, ResponseEnum responseStatus) {
